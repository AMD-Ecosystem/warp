...
def build_cuda(
    ...
    *,
    ...
    if llvm_cuda:
        ...
        # Pass the user-provided extra include dirs (upstream feature) together with
        # the ROCm/HIP header dirs that HIPRTC needs (AMD). Both are routed through
        # the single include-dir slot of wp_cuda_compile_program.
